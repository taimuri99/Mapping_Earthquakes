...
// Create the map object with center, zoom level and default layer. Toronto centred map
let map = L.map('mapid', {
  center: [43.7, -79.3],
  zoom: 11,
  layers: [streets]
...
// let torontoData = "https://raw.githubusercontent.com/taimuri99/Mapping_Earthquakes/main/torontoRoutes.json";

// Accessing the Toronto neighborhoods GeoJSON URL.
let torontoHoods = "https://raw.githubusercontent.com/taimuri99/Mapping_Earthquakes/main/torontoNeighborhoods.json";
...
L.geoJSON(data ,{
  ...
  onEachFeature: function(feature, layer) {
    console.log(layer);
    layer.bindPopup("<h2> Neigbourhood: " + feature.properties.AREA_NAME + "</h2>");
   }
  }).addTo(map);
});
